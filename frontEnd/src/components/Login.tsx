...
const Login: FC<LoginProps> = ({ setLoginUser }) => {
    ...
    const login = (): void => {
        axios.post("http://localhost:5001/api/auth", user)
            .then(res => {
        ...
        <>
         <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
                    ...
                    <form action="#" autoComplete="off">
                        ...
                        <div className="flex flex-col mb-6">
                            <div className="flex relative ">
                                ...
                                <input type="password" id="sign-in-password" className="rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" name="password" value={user.password} onChange={handleChange} placeholder="Your password" />
                            </div>
                        </div>
                ...
                <div className="flex items-center justify-center mt-6">
                    <a href="#" target="_blank" className="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white" onClick={() => navigate("/Register")}>
                        <span className="ml-2">
